...
jQuery(function($) {
    ...
    jQuery(grid_selector).jqGrid({
        ...
        data: grid_data,
        height: 392,
        colNames:['用户','类型','描述', '状态', '时间'],
        colModel:[
            {name:'id',index:'id', width:60, sorttype:"int", editable: true},
            {name:'name',index:'name',width:90, editable:true, sorttype:"date",unformat: pickDate},
            {name:'note',index:'bote', width:150,editable: true,editoptions:{size:"20",maxlength:"30"}},
            {name:'stock',index:'stock', width:70, editable: true,edittype:"checkbox",editoptions: {value:"Yes:No"},unformat: aceSwitch},
            {name:'sdate',index:'sdate', width:90, editable: true,edittype:"select",editoptions:{value:"FE:FedEx;IN:InTime;TN:TNT;AR:ARAMEX"}}
        ],
        rownumbers:true,
        viewrecords : true,
        rowNum:10,
