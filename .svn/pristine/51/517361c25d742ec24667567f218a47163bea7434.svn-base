...
var colModel = [
    ...
    {name:'subscribePrice',index:'subscribePrice'},
    {name:'orderStatus',index:'orderStatus'},
    {name:'theArrivalStatus',index:'theArrivalStatus'},
    {name:'theArrivalPrice',index:'theArrivalPrice'},
...
function initGrid(grid_selector, pager_selector){
    jQuery(grid_selector).jqGrid({
        ...
        height: 392,
        // 表头名称
        colNames:['题名', '唯一订阅号','印本ISSN','电子版ISSN','订单价格','发订状态','是否到货','到货价格','操作'],
        // 表头数据
        colModel:colModel,
        //添加左侧行号
        rownumbers: true,
