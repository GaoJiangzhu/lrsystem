...
var colModel = [
    ...
    {name:'realName',index:'realName',width:90,align:"center"},
    {name:'email',index:'email', width:150,align:"center",},
    {name:'isAdmin',index:'isAdmin', width:70,align:"center"},
    {name:'createDate',index:'createDate', width:90, align:"center"},
    {name:'loginDate',index:'loginDate', width:150, align:"center"},
...
function initGrid(grid_selector, pager_selector){
    jQuery(grid_selector).jqGrid({
        ...
        mtype:"GET",
        height: 392,
        colNames:['登录名','真实姓名', '邮件地址','管理员','创建于','最后登录','操作'],
        colModel:colModel,
        rownumbers: true,
        viewrecords : true,
        rowNum:10,
